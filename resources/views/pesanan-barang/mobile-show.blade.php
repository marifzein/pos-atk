...
<div class="space-y-3 pb-20">
    ...
    <div>
        <a href="{{ route('pesanan-barang.history') }}" class="inline-flex items-center gap-1.5 text-xs font-bold text-slate-600 bg-white px-3 py-2 rounded-xl border border-slate-200 active:scale-95 transition">
    ...
    <div class="bg-white rounded-2xl p-3.5 shadow-xs border border-slate-100 space-y-3">
        <h3 class="font-black text-slate-800 text-xs uppercase tracking-wider flex items-center gap-1.5 border-b border-slate-100 pb-2">
            <i class="ri-box-3-line text-indigo-600"></i> Rincian Item Barang
        </h3>
